...
| -------------- | ---- | ------- | -------- | ----------- |
| `hostId` | `string` | N/A | Yes | This is the "password" to your Hackbox room - it will be used to connect to the WebSocket. If shared, your room could be hijacked. Don't reuse this. |
